...
function preloadInitiatives() {
    ...
    const predefinedInitiatives = [
        ...
        { id: 33, titulo: "Caminhada Fotográfica", type: "Corrida/Maratona", localidade: "Parque das Artes", region: "Alentejo", data: "2024-05-27", horaInicio: "15:00", horaFim: "18:00", descricao: "Caminhada pela natureza com foco em fotografia de paisagem.", imagem: "../../assets/fotografia.jpg", participantes: ["jorge@hotmail.com", "joana@gmail.com"], doacoes: 0, materiais: [], profissionais: [], gestor: "s.thor@example.com", participantesmax: 100 },
        { id: 34, titulo: "Feira de Saúde e Bem-Estar", type: "Outro", localidade: "Praça Central", region: "Centro", data: "2024-05-29", horaInicio: "08:00", horaFim: "18:00", descricao: "Feira com exposições, atividades e palestras sobre saúde e bem-estar.", imagem: "../../assets/bem-estar.jpg", participantes: ["jorge@hotmail.com", "joana@gmail.com"], doacoes: 0, materiais: [], profissionais: ["rosa.vieira@example.com", "ana.luisa@example.com"], gestor: "s.thor@example.com", participantesmax: 100 },
        { id: 35, titulo: "Corrida do Mosteiro", type: "Corrida/Maratona", localidade: "Mire de Tibães, Braga", region: "Norte", data: "2024-05-29", horaInicio: "12:00", horaFim: "19:00", descricao: "Junte-se a nós numa corrida noturna pelas históricas ruas de Mire de Tibães, iluminando caminhos com esperança e união pela caridade.", imagem: "../../assets/1.jpg", participantes: ["jorge@hotmail.com", "joana@gmail.com"], doacoes: 0, materiais: [], profissionais: ["rosa.vieira@example.com", "ana.luisa@example.com"], gestor: "s.thor@example.com", participantesmax: 500 },
...
function preloadPedidos() {
    ...
    const predefinedPedidos = [
        { id: 1, estado: "pendente" ,email: "carlosjoao@example.com", titulo: "Corrida do Norte", type: "Corrida/Maratona", localidade: "Avenida da Liberdade - Porto", region: "Norte", data: "2024-06-10", horaInicio: "09:00", horaFim: "11:00", descricao: "Uma maratona urbana para todos os níveis de corredores.", imagem: "../../assets/maratona1.jpg" },
        { id: 2, estado: "pendente" ,email: "carlosjoao@example.com", titulo: "Aulas de Yoga - Conti", type: "Aulas", localidade: "Parque das Águas", region: "Lisboa", data: "2024-06-12", horaInicio: "08:00", horaFim: "10:00", descricao: "Sessão de yoga ao ar livre para promover a saúde e o bem-estar.", imagem: "../../assets/yoga.jpg" },
        { id: 3, estado: "pendente" ,email: "carlosjoao@example.com", titulo: "Jogo de Futebol Beneficente dos Alves", type: "Jogos de Futebol", localidade: "Estádio Municipal", region: "Norte", data: "2024-06-15", horaInicio: "15:00", horaFim: "17:00", descricao: "Jogo de futebol para arrecadar fundos para a caridade local.", imagem:"../../assets/futebol2" },
        { id: 4, estado: "pendente" ,email: "carlosjoao@example.com", titulo: "Workshop de Fotografia", type: "Workshop", localidade: "Centro Cultural", region: "Alentejo", data: "2024-06-18", horaInicio: "10:00", horaFim: "12:00", descricao: "Workshop introdutório sobre técnicas de fotografia digital.", imagem: "../../assets/fotografia.jpg" },
        { id: 5, estado: "pendente" ,email: "carlosjoao@example.com", titulo: "Aula de Pilates", type: "Aulas", localidade: "Parque da Avenida", region: "Norte", data: "2024-06-24", horaInicio: "15:00", horaFim: "17:00", descricao: "Sessão de pilates ao ar livre para promover a saúde e o bem-estar.", imagem: "../../assets/pilates.jpg" },
        { id: 6, estado: "pendente" ,email: "carlosjoao@example.com", titulo: "Festa de Panóias", type: "Outro", localidade: "Marquês de Pombal", region: "Centro", data: "2024-07-01", horaInicio: "17:00", horaFim: "22:00", descricao: "Panóias Solidaria", imagem: "../../assets/socorros.jpeg" },
        { id: 7, estado: "recusado" ,email: "carlosjoao@example.com", titulo: "Aula de Pilates", type: "Aulas", localidade: "Parque da Avenida", region: "Norte", data: "2024-06-24", horaInicio: "15:00", horaFim: "17:00", descricao: "Sessão de pilates ao ar livre para promover a saúde e o bem-estar.", imagem: "../../assets/pilates.jpg" },
        { id: 8, estado: "aceite" ,email: "carlosjoao@example.com", titulo: "Aula Continente de Raiki", type: "Aulas", localidade: "Parque da Avenida", region: "Norte", data: "2024-04-24", horaInicio: "15:00", horaFim: "17:00", descricao: "Sessão de pilates ao ar livre para promover a saúde e o bem-estar.", imagem: "../../assets/pilates.jpg"}
    ];
